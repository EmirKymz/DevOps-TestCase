...
- SSH ayarlamaları için sshd_config dosyası düzenlendi.
...
- Uncomplicated Firewall, Ubuntu ve Debian tabanlı sistemlerde kullanılan bir güvenlik duvarı yazılımıdır. ufw, güvenlik duvarı kurallarını yönetmek için basit bir arayüz sağlar.
...
- `ufw enable` ufw güvenlik duvarını etkinleştirir.
